function send() {
    ...
    docuument.getElementById("output").innerHTML = row;
  
    docuument.getElementById("number1").value = "";
    docuument.getElementById("number2").value = "";
   }
...
function check()
{
    ...
    if(get_answer == actual_answer)
    {
        if (answer_turn == "player1")
        {
            ...
            document.getElementById("player1_socre").innerHTML = player1_score;
        }
        else
        {
